                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input value="{{ old('address') }}" type="text" class="form-control"
                                                        id="address" aria-describedby="emailHelp" name="address"
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input value="{{ old('contact_number') }}" type="text"
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input value="{{ old('brela_reg_number') }}" type="text"
                                                        class="form-control" id="brela_reg_number"
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input value="{{ old('tin_number') }}" type="text"
                                                        class="form-control" id="tin_number" name="tin_number">
                                                    @error('tin_number')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
