                    ...
                    <div class="card-body ">
                        ...
                        @can('create_paygrade')
                            ...
                            <x-system.modal size="modal-lg" id="createPayGrade" title="Create PayGrade" form="createPayGradeForm">
                                <form id="createPayGradeForm" action="{{ route('employee.manage.paygrades.store') }}"
                                    method="POST">
                                    @csrf
                                    ...
                                    @forelse($pay_grades as $key => $pay_grade)
                                        ...
                                        --}}
                                            ...
                                            <td class="d-flex p-1 gap-1">
                                                ...
                                                @can('edit_paygrade')
                                                    <x-system.modal-button
                                                        class="btn btn-outline-dark btn-sm p-1 mx-1 mdi mdi-pencil"
                                            ...
                                            <div class="card shadow-sm border-0">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-8">{{ number_format($pay_grade->base_salary, 2) }}
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <div class="col-md-4 font-weight-bold">Max Salary:</div>
                                                        <div class="col-md-8">{{ number_format($pay_grade->max_salary, 2) }}
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                        ...
                                        @can('edit_paygrade')
                                            <x-system.modal size="modal-lg" id="editPayGrade{{ $pay_grade->id }}"
                                                title="Edit Pay Grade" form="editPayGradeForm{{ $pay_grade->id }}">
                                                <form id="editPayGradeForm{{ $pay_grade->id }}"
                                                    action="{{ route('employee.manage.paygrades.update', $pay_grade) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PATCH')
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="name">PayGrade Name</label>
                                                            <input type="text" value="{{ $pay_grade->name }}"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="description">{{ $pay_grade->description }}</textarea>
                                                        </div>
                                                    </div>
                                                </form>
                                            </x-system.modal>
