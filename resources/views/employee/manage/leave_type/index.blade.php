                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table dt-table table-bordered table-striped" id="leaveTypeTable">
                                    <thead>
                                        <tr>
                                            <td>#</td>
                                            <th>Leave Type</th>
...
@section('scripts')
    <script>
        const app = Vue.createApp({
            ...
            mounted() {
                console.log('Vue app mounted start using me');
            },
            methods: {
            ...
            computed: {
                showCompensated() {
                    console.log("is deducted: ", this.isDeducted);
