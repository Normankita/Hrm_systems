        ...
        <div class="row">
            <div class="col-12">
                <div class="py-6 bg-gray-100 min-h-screen ">
                    ...
                    @canany(['view_employees', 'view_payroll', 'create_payment', 'view_paygrade', 'view_leave_requests',
                        'view_leaveTypes'])
                        <div class="card my-6 shadow-lg">
                            ...
                            <div class="card-body">
                                <div class="container-fluid py-4">
                                    ...
                                    <!-- Stats Cards Row -->
                                    @canany(['view_employees', 'view_leave_requests'])
                                        <div class="row mb-4">
                                            @can('view_employees')
                                            ...
                                            @canany(['view_leave_requests', 'respond_leave_request'])
                                                <div class="col-xl-3 col-md-6 mb-4">
                                                    <div class="card dashboard-card stat-card"
                                            ...
                                            <div class="col-xl-3 col-md-6 mb-4">
                                                <div class="card dashboard-card stat-card"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div>
                                                                <h6 class="text-uppercase text-white mb-1">Open Positions
                                                                </h6>
                                                                <h2 class="mb-0">5</h2>
                                                            </div>
                                        ...
                                        @canany(['view_leave_requests', 'respond_leave_request'])
                                            <div class="row mb-4">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <span
                                                                                        ...
                                                                                        @else bg-warning @endif badge text-white">
                                                ...
                                                @canany(['view_leaveTypes', 'edit_leaveType', 'delete_leaveType',
                                                    'create_leaveType'])
                                                    <div class="col-12">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    @canany(['edit_leaveType', 'delete_leaveType',
                                                                        'create_leaveType'])
                                                                        <div class="mb-3 col-5">
                                                                            <a href="#" class="btn btn-primary btn-sm">
                                                                                manage leave Types
                                                ...
                                                <div class="card-body">
                                                    <div class="list-group">
                                                        <a href="#" class="list-group-item list-group-item-action">
                                                            ...
                                                            <p class="mb-1">Annual team building at Central Park
                                                            </p>
                                                        </a>
                                                        <a href="#" class="list-group-item list-group-item-action">
                                                            <div class="d-flex w-100 justify-content-between">
                                                        ...
                                                        <a href="#" class="list-group-item list-group-item-action">
                                                            ...
                                                            <p class="mb-1">New Software Training for IT
                                                                Department</p>
                                                        </a>
                                                    </div>
                                                </div>
