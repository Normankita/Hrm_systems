                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="phone_number" class="form-control" placeholder="+255712345678" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="national_id" class="form-control" placeholder="1234567890123456" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="marital_status" class="form-control" placeholder="e.g., Single, Married">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="residential_address" class="form-control" placeholder="e.g., Sinza Mori, Dar es Salaam">
                            </div>
                        </div>
