            ...
            <div class="card">
                <div class="card-body ">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <x-system.modal size="modal-lg" id="CreateSetting" title="Create New Setting" form="CreateSettingForm">
                            ...
                            <x-slot name="body">
                                <x-system.table-body>
                                    @foreach ($settings as $key => $setting)
                                        ...
                                        <x-system.modal size="modal-lg" id="editSetting{{ $setting->id }}"
                                            :title="'Edit ' . $setting->name" form="editSettingForm{{ $setting->id }}">
