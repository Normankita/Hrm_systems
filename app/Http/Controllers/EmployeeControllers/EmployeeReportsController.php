...
class EmployeeReportsController extends Controller
{
    ...
    {
        return view('employee.manage.reports.index');
    }

    public function employees()
    {
        return view('employee.manage.reports.employees');
    }
    ...
    public function employeesExport(Request $request)
    {
        ...
        if ($format === 'pdf') {
            ...
            return PdfTrait::generatePdf(
                'employee.manage.reports.pdf.employees',
                $filenameBase,
                [
                    'rows' => $rows,
                    'generatedAt' => now(),
        ...
        return $this->streamCsv(
            $query,
            $filenameBase . '.csv',
            ['ID', 'Full Name', 'Email', 'Phone', 'Type', 'State', 'Department', 'Date Of Hire'],
            function (Employee $e) {
                return [
                    $e->id,
                    $e->full_name,
    ...
    {
        return view('employee.manage.reports.attendance');
    }
    ...
    public function attendanceExport(Request $request)
    {
        ...
        if ($format === 'pdf') {
            ...
            return PdfTrait::generatePdf(
                'employee.manage.reports.pdf.attendance',
                $filenameBase,
                [
                    'rows' => $rows,
                    'generatedAt' => now(),
    ...
    {
        return view('employee.manage.reports.payroll');
    }
    ...
    public function payrollExport(Request $request)
    {
        ...
        if ($format === 'pdf') {
            ...
            return PdfTrait::generatePdf(
                'employee.manage.reports.pdf.payroll',
                $filenameBase,
                [
                    'rows' => $rows,
                    'generatedAt' => now(),
